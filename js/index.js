const handle = async() =>{
 ...
 console.log(data.data);
    ...
    const data=await response.json();
      ...
      <figure><img src="/image/pentagon.png" alt="Shoes" /></figure>
      <div class="card-body">
        <div class="flex flex-row">
          <img class="rounded-full w-[40px] h-[40px]" src="image/prod7.png" alt="">
        <h2 class="card-title font-bold text-base">Building a Winning UX Strategy Using the Kano Model</h2>
        </div>
        <div class="flex flex-row gap-[9px] pl-[15px]">
          <span class="text-sm font-normal ">Awlad Hossain</span>
        ...
        <p class="text-sm font-normal pt-[10px] pl-[15px]">91K views</p>
